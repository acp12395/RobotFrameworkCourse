*** Settings ***
Documentation    Fill out a form making use of a CSV file
Library    SeleniumLibrary
Library    DataDriver    ./Book.csv
Suite Setup    General Setup
Test Setup    Initialize Browser
Test Template    Fill with CSV File
...
*** Test Cases ***
Fill out a form with CSV File #${trialNo}